...
namespace System.Drawing.CompareTestNunit
{
    public class IntegrationTest
    {
        ...
        [Test]
        [TestCase(jpgCalc0, pngCalc0, 443191, 2, 153760, 95.122615129543945d)]
        [TestCase(jpgCalc1, pngCalc1, 441320, 2, 153802, 95.148598153967981d)]
        [TestCase(pngCalc1, pngCalc1, 0, 0, 0, 0)]
        [TestCase(jpgCalc1, jpgCalc1, 0, 0, 0, 0)]
        [TestCase(jpgCalc0, jpgCalc1, 208886, 1, 2094, 1.2954393605701418d)]
        [TestCase(pngCalc0, pngCalc1, 203027, 1, 681, 0.42129618173269651d)]
